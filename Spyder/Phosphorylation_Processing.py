...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 09:42:43 2023
...
sequence_offset = 0
dataset = "/Users/lucas/Documents/UZH/4_jahr_HS_2023/ResearchProject_NMR/Python/Phos_processing_script_workflow/Dummy_data/"

# Define which measurements and the last measurement, from which the fucntion starts
apo_peaklist = dataset + "622" + "/pdata/1/peaklist.xml"
ligand_list_unassigned = [622, 562, 502, 442, 382, 322, 262, 202, 142, 82, 22]
...
reference_row_index = 1  # For example, using row 2 as the reference row
...
to_be_fit_array = normalised_array[:1, :] #row 0 and 1 are now fitted
# print("\n to be fitted data:\n", to_be_fit_array)
...
data_labels = ["Amino acid X", "Amino acid Y"]
...
ax.set_title('hsB2AR 03 GRK2 wt')
ax.legend()
